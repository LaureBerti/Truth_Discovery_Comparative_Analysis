...
public class Globals {
	...
	public static final String voterCopyTT = "AccuCopy T T";
	public static final String voterCopyTF = "AccuCopy T F";
	public static final String voterCopyFT = "AccuCopy F T";// no similarity with accuracy
	public static final String voterCopyFF = "AccuCopy F F";
	...
	// Books dataSet
	public static final String directory_UnformattedBooksFiles = directory_UN_formattedDAFNADataset + "/unformatted/Book/Books";
	...
	public static final String directory_syntheticDataSet_Boolean = directory_formattedDAFNADataset +  "/syntheticBoolean/claims";
	public static final String directory_syntheticDataSet_Boolean_Truth = directory_formattedDAFNADataset +  "/syntheticBoolean/truth";
	public static final String directory_syntheticDataSet_BooleanTrueAndFalse = directory_formattedDAFNADataset +  "/syntheticBooleanTrueAndFasle/claims";
	public static final String directory_syntheticDataSet_BooleanTrueAndFalse_Truth = directory_formattedDAFNADataset +  "/syntheticBooleanTrueAndFasle/truth";
	...
	public static final int iterationCount = 50;
